...
type Order struct {
	ID                 int64  `gorm:"primaryKey;column:id;type:bigint;comment:'主键ID'"`                                         // 主键
	UserID             int64  `gorm:"column:user_id;type:bigint;not null;comment:'用户ID';uniqueIndex:idx_user_time,priority:1"` // 逻辑外键
	Ctime              int64  `gorm:"column:ctime;type:bigint;not null;comment:'创建时间';uniqueIndex:idx_user_time,priority:2"`   // 创建时间
